...
# =========【必改 1】四个预处理 CSV 路径 =========
X_TRAIN_PATH = r"D:\MLDesignAl\TheFinal\Data\ElementTreatment-EL\output\ElementTreatment-EL-X_train.csv"
Y_TRAIN_PATH = r"D:\MLDesignAl\TheFinal\Data\ElementTreatment-EL\output\ElementTreatment-EL-y_train.csv"
X_TEST_PATH  = r"D:\MLDesignAl\TheFinal\Data\ElementTreatment-EL\output\ElementTreatment-EL-X_test.csv"
Y_TEST_PATH  = r"D:\MLDesignAl\TheFinal\Data\ElementTreatment-EL\output\ElementTreatment-EL-y_test.csv"

# =========【必改 2】运行模式与输出目录 =========
MANUAL_TUNE = False                                 # 调参期 True；确定参数后改 False
OUTPUT_DIR  = Path(r"D:\MLDesignAl\TheFinal\KNN\ElementTreatment-EL\output")
...
def get_scaler(name: str):
    ...
    if name == 'identity': return 'passthrough'  # 不做缩放
    raise ValueError(f"Unknown scaler: {name}")

# =========【必改 3A】手动调参参数组（MANUAL_TUNE=True 时使用）=========
MANUAL_TRIALS = [
    {"n_neighbors": 31, "weights": "distance",  "p": 1,   "leaf_size": 5},

    {"n_neighbors": 31, "weights": "distance",  "p": 1,   "leaf_size": 10},

    {"n_neighbors": 31, "weights": "distance",  "p": 1,   "leaf_size": 15},

    {"n_neighbors": 31, "weights": "distance",  "p": 1,   "leaf_size": 20},
]
