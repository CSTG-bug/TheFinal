...
OUTPUT_DIR  = Path(r"D:\MLDesignAl\TheFinal\KNN\ElementTreatmentUTS-EL\output")
...
MANUAL_TRIALS = [
    {"n_neighbors": 3, "weights": "distance",  "p": 1,   "leaf_size": 5},

    {"n_neighbors": 3, "weights": "distance",  "p": 1,   "leaf_size": 10},
