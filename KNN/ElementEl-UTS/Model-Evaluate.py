...
OUTPUT_DIR  = Path(r"D:\MLDesignAl\TheFinal\KNN\ElementEl-UTS\output")

# ========= 保存策略（只在 MANUAL_TUNE=False 分支里生效）=========
MASTER_SAVE_SWITCH = False                         # 满意后改 True 才允许落盘
...
MANUAL_TRIALS = [
    ...
    {"n_neighbors": 5, "weights": "uniform",  "p": 1,   "leaf_size": 20},

    {"n_neighbors": 5, "weights": "uniform",  "p": 1,   "leaf_size": 30},

    {"n_neighbors": 5, "weights": "uniform",  "p": 1,   "leaf_size": 40},
]
