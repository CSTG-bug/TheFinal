...
OUTPUT_DIR = Path(r"D:\MLDesignAl\TheFinal\RF\Element-UTS-BX\output")
...
MANUAL_TRIALS = [
    ...
    {"n_estimators": 903, "max_features": "sqrt", "max_depth": 20,
     "min_samples_leaf": 3, "min_samples_split": 13, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 906, "max_features": "sqrt", "max_depth": 20,
     "min_samples_leaf": 3, "min_samples_split": 13, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 910, "max_features": "sqrt", "max_depth": 20,
     "min_samples_leaf": 3, "min_samples_split": 13, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 913, "max_features": "sqrt", "max_depth": 20,
     "min_samples_leaf": 3, "min_samples_split": 13, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 916, "max_features": "sqrt", "max_depth": 20,
     "min_samples_leaf": 3, "min_samples_split": 13, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},
