...
OUTPUT_DIR = Path(r"D:\MLDesignAl\TheFinal\RF\Element-UTS-new\output")
...
MANUAL_TRIALS = [
    ...
    {"n_estimators": 1690, "max_features": 0.2, "max_depth": 20,
     "min_samples_leaf": 2, "min_samples_split": 2, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 1700, "max_features": 0.2, "max_depth": 20,
     "min_samples_leaf": 2, "min_samples_split": 2, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 1710, "max_features": 0.2, "max_depth": 20,
     "min_samples_leaf": 2, "min_samples_split": 2, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 1720, "max_features": 0.2, "max_depth": 20,
     "min_samples_leaf": 2, "min_samples_split": 2, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 1730, "max_features": 0.2, "max_depth": 20,
     "min_samples_leaf": 2, "min_samples_split": 2, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},
