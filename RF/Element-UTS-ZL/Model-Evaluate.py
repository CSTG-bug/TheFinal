...
OUTPUT_DIR = Path(r"D:\MLDesignAl\TheFinal\RF\Element-UTS-ZL\output")
...
MANUAL_TRIALS = [
    ...
    {"n_estimators": 500, "max_features": 0.5, "max_depth": 15,
     "min_samples_leaf": 1, "min_samples_split": 12, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 800, "max_features": 0.5, "max_depth": 15,
     "min_samples_leaf": 1, "min_samples_split": 12, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 900, "max_features": 0.5, "max_depth": 15,
     "min_samples_leaf": 1, "min_samples_split": 12, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 1000, "max_features": 0.5, "max_depth": 15,
     "min_samples_leaf": 1, "min_samples_split": 12, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 1100, "max_features": 0.5, "max_depth": 15,
     "min_samples_leaf": 1, "min_samples_split": 12, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},
