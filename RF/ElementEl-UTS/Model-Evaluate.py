...
OUTPUT_DIR = Path(r"D:\MLDesignAl\TheFinal\RF\ElementEl-UTS\output")
...
MANUAL_TRIALS = [
    ...
    {"n_estimators": 700, "max_features": 0.7, "max_depth": 30,
     "min_samples_leaf": 2, "min_samples_split": 2, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 800, "max_features": 0.7, "max_depth": 30,
     "min_samples_leaf": 2, "min_samples_split": 2, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 900, "max_features": 0.7, "max_depth": 30,
     "min_samples_leaf": 2, "min_samples_split": 2, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 1000, "max_features": 0.7, "max_depth": 30,
     "min_samples_leaf": 2, "min_samples_split": 2, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},

    {"n_estimators": 1100, "max_features": 0.7, "max_depth": 30,
     "min_samples_leaf": 2, "min_samples_split": 2, "bootstrap": True, "oob_score": True,
     "random_state": SEED, "n_jobs": -1},
