...
OUTPUT_DIR  = Path(r"D:\MLDesignAl\TheFinal\SVR\Element-UTS-ZL\output")
...
SCALER_CHOICE = 'standard'    # 若 CSV 已经缩放过，保持 'identity' 避免二次缩放
...
MANUAL_TRIALS = [
    {"kernel": "rbf", "C": 75, "epsilon": 7.5, "gamma": 0.01},

    {"kernel": "rbf", "C": 75, "epsilon": 7.5, "gamma": 0.02},

    {"kernel": "rbf", "C": 75, "epsilon": 7.5, "gamma": 0.03},

    {"kernel": "rbf", "C": 75, "epsilon": 7.5, "gamma": 0.04},

    {"kernel": "rbf", "C": 75, "epsilon": 7.5, "gamma": 0.05},

    {"kernel": "rbf", "C": 75, "epsilon": 7.5, "gamma": 0.06},
]
...
FINAL_SCALER = 'standard'     # 'standard' / 'minmax' / 'robust' / 'identity'
