...
# =========【必改 1】四个预处理 CSV 路径 =========
X_TRAIN_PATH = r"D:\MLDesignAl\TheFinal\Data\ElementEl-UTS\output\ElementEl-UTS-X_train.csv"
Y_TRAIN_PATH = r"D:\MLDesignAl\TheFinal\Data\ElementEl-UTS\output\ElementEl-UTS-y_train.csv"
X_TEST_PATH  = r"D:\MLDesignAl\TheFinal\Data\ElementEl-UTS\output\ElementEl-UTS-X_test.csv"
Y_TEST_PATH  = r"D:\MLDesignAl\TheFinal\Data\ElementEl-UTS\output\ElementEl-UTS-y_test.csv"

# =========【必改 2】运行模式与输出目录 =========
MANUAL_TUNE = False                                                     # 调参期 True；定型后改 False
OUTPUT_DIR  = Path(r"D:\MLDesignAl\TheFinal\SVR\ElementEl-UTS\output")
...
MANUAL_TRIALS = [
    {"kernel": "rbf", "C": 5191, "epsilon": 13.7, "gamma": 0.05},
